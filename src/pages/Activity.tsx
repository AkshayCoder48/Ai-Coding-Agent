...
<div className="relative pl-14 pb-12 group">
<div className="activity-timeline-line"></div>
<div className="absolute left-0 top-0 size-10 rounded-full bg-white/5 border border-white/20 flex items-center justify-center text-white z-10 group-hover:scale-110 transition-transform">
...
<div className="flex items-center justify-between mb-2">
<div className="flex items-center gap-3">
<span className="text-xs font-mono px-2 py-0.5 rounded bg-white/5 text-slate-300 border border-white/10 uppercase tracking-wide">GitHub Action</span>
...
<div className="absolute left-0 top-0 size-10 rounded-full bg-slate-500/10 border border-dashed border-slate-500/30 flex items-center justify-center text-slate-500 z-10">
...
<button className="bg-white text-black px-6 py-2 rounded-lg font-bold text-sm hover:bg-slate-200 transition-all flex items-center gap-2">
