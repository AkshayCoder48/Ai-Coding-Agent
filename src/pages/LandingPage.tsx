...
<a className="text-slate-400 hover:text-white text-sm font-medium transition-colors" href="#">Docs</a>
...
<Link to="/workspace"  className="flex min-w-[100px] cursor-pointer items-center justify-center rounded-lg h-10 px-5 bg-primary text-white text-sm font-bold shadow-lg shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] active:scale-[0.98] transition-all"><span className="truncate">Sign in</span></Link>
</div>
</header>
...
<button className="flex items-center gap-2 rounded-full bg-onyx-surface border border-onyx-border px-4 py-1.5 text-slate-300 text-sm hover:border-primary/50 hover:bg-primary/5 transition-all">
...
<img className="w-full h-full object-cover opacity-60 grayscale hover:grayscale-0 transition-all duration-700" data-alt="Modern code editor displaying React code with high-tech UI" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCQwLkRLAVFJdsu0fil5AtTjxXD5wpfjx-Hw57-U3dqU-e4enNjT60ZZbmUrhxUPV3DaZdSsZP8F0bauyYbt9-34nwGp9tDYMhfQAoBYp0dQYBMsxJhflpDuipTv3T33yVnsKnHyNGosoGWhg8y1FXytcAMvVtzD4NHN_NO88fRz5Ho0lVj2-C0fHW35KHMmgHXOeVEYzwkUkjVgOwTPi1OHdmEreGOJhQcD9VJFagW-xKxyZbc9C9SwZEGCG-0it1nYQULT-_IXMs"/>
